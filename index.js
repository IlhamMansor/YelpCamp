...
const store = MongoStore.create({ mongoUrl: dbUrl, secret: secret, touchAfter: 24 * 60 * 60 });
...
app.use(
  helmet.contentSecurityPolicy({
    directives: {
      ...
      workerSrc: ["'self'", "blob:"],
      objectSrc: [],
      imgSrc: ["'self'", "blob:", "data:", "https://res.cloudinary.com/dgi9fzukm/", "https://images.unsplash.com/"],
